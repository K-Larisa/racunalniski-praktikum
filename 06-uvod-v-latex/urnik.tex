...
\item Razred \emph{Predavalnica} nosi podatke o kapaciteti predavalnice, njeno
      oznako ter podatke o zasedenosti, ki so predstavljeni s tabelo.
...
Rešitev se ponuja kar sama -- za naslednjih \(n\)
korakov prepovemo vsako spremembo, ki jo
...
spremembo (npr.\ zamenjava \(\text{srečanja}_{i}\) in \(\text{predmet}_{j}\)) sedaj shranimo v
